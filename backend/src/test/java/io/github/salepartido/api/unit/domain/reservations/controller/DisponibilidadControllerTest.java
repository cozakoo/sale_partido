...
class DisponibilidadControllerTest {
        ...
        @Test
        void getDisponibilidad_ConFechaInicioPasada_RetornaOk() throws Exception {

                when(disponibilidadService.obtenerDisponibilidadLocal(any(), any(), any()))
                                .thenReturn(List.of());
                ...
                verify(disponibilidadService, times(1))
                                .obtenerDisponibilidadLocal(any(), any(), any());
        }
