...
- **Tareas por cada HU** - Tareas tecnicas y funcionales 
- **Tasks** — Trabajo técnico
- **Estados de la HU:** Analisis → En desarrollo → Verifcacion → Despligue → Terminado
...
### Consultar agente IA
```
1. Abre /agents/backend.md (o frontend.md)
...
- Usa `/agents/API_CONTRACTS.md` para coordinar con frontend
...
[copiar TODO de /agents/backend.md]
...
- [ ] Consulté `/agents/API_CONTRACTS.md` si hay coordinación
