...
1. **Actualiza** `/agents/API_CONTRACTS.md` con nuevo endpoint
...
Si eres developer:
1. **Primero:** `/documentation/workflow/GITHUB_PROJECTS.md` — Entiende HUs en GitHub Projects
2. **Segundo:** `/agents/ONBOARDING.md` — Cómo codificar paso a paso
3. **Referencia:** `/documentation/` (stack, testing, troubleshooting)
...
- Stack detallado → `/documentation/architecture/STACK.md`
- Testing estrategia → `/documentation/workflow/TESTING.md`
- Troubleshooting → `/documentation/guides/TROUBLESHOOTING.md`
- Decisiones → `/documentation/decisions/Decisiones.md`
