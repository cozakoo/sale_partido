...
- **Frontend instructions:** `/agents/frontend.md` (este archivo)
- **Contratos API:** `/agents/API_CONTRACTS.md` ← Endpoints y DTOs
- **Convenciones Git:** `/documentation/workflow/Convenciones_de_branching.md`
- **Angular:** https://angular.io/docs
- **TypeScript:** https://www.typescriptlang.org/documentation/
- **Playwright:** https://playwright.dev/documentation/intro
- **Bootstrap 5:** https://getbootstrap.com/documentation/5.0/
