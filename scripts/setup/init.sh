...
# Configura .env y todo lo necesario para el workflow automático
...
echo -e "   ${BLUE}./scripts/run.sh github:sync${NC}"
echo ""
echo -e "3️⃣  (Opcional) Descarga el tablero actual:"
echo -e "   ${BLUE}./scripts/run.sh github:board${NC}"
echo ""
echo -e "4️⃣  Comienza el flujo:"
echo -e "   ${BLUE}./scripts/run.sh github:validate E4-H08${NC}"
echo -e "   ${BLUE}./scripts/run.sh git:branch E4-H08 crear-local${NC}"
echo -e "   ${BLUE}[codifica con IA...]${NC}"
echo -e "   ${BLUE}git commit -m 'tu mensaje aquí'${NC}"
echo ""
