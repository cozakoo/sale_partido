 ...
 *
 * Genera:
 * - documentation/.local/data/BOARD.json (estado completo del tablero)
 * - documentation/.local/data/BOARD.md (vista legible)
 */
...
const BOARD_JSON = path.join(__dirname, '../../documentation/.local/data/BOARD.json');
const BOARD_MD = path.join(__dirname, '../../documentation/.local/data/BOARD.md');
