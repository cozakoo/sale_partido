...
|--------|---------|---------|
| **Backineitor** ⚙️ (Backend) | `/agentes/backend.md` | `/agentes/API_CONTRACTS.md` |
| **Frontalyx** 🎨 (Frontend) | `/agentes/frontend.md` | `/agentes/API_CONTRACTS.md` |
| **Kuberator** ☸️ (DevOps) | `/agentes/infra.md` | `/doc/TROUBLESHOOTING.md` |
| **Testeador** ✅ (QA) | `/agentes/qa.md` | `/doc/TESTING.md` |
...
**Ver más:** `/doc/GITHUB_PROJECTS.md`
...
**Archivo:** `/agentes/API_CONTRACTS.md`
...
| Documento | Para |
|-----------|------|
| `/doc/Decisiones.md` | Decisiones arquitectónicas ya tomadas |
| `/doc/Convenciones_de_branching.md` | Convención de commits y ramas |
| `/doc/TESTING.md` | Estrategia de testing detallada |
| `/doc/TROUBLESHOOTING.md` | Errores comunes y soluciones |
| `/doc/STACK.md` | Stack técnico detallado |
